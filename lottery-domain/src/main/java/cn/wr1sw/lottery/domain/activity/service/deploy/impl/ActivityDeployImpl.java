package cn.wr1sw.lottery.domain.activity.service.deploy.impl;
...
import cn.wr1sw.lottery.domain.activity.model.req.ActivityConfigReq;
...
import cn.wr1sw.lottery.domain.activity.model.vo.AwardVO;
import cn.wr1sw.lottery.domain.activity.model.vo.StrategyDetailVO;
import cn.wr1sw.lottery.domain.activity.model.vo.StrategyVO;
...
public class ActivityDeployImpl implements IActivityDeploy {
    ...
    public void createActivity(ActivityConfigReq req) {
        logger.info("创建活动配置开始, {}", req.getActivityId());
