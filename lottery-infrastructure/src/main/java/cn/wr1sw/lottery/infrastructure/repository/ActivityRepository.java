...
import cn.wr1sw.lottery.domain.activity.model.res.StockResult;
import cn.wr1sw.lottery.domain.activity.model.vo.*;
import cn.wr1sw.lottery.domain.activity.repository.IActivityRepository;
import cn.wr1sw.lottery.infrastructure.dao.*;
import cn.wr1sw.lottery.infrastructure.po.*;
import cn.wr1sw.lottery.infrastructure.util.RedisUtil;
...
//        activityBillVO.setStockSurplusCount(null == usedStockCountObj ? activity.getStockCount() : Integer.parseInt(String.valueOf(usedStockCountObj)));
